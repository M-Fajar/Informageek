            ...
            <div class="card border-0 mx-auto card-shadow">
                <div class="card-body p-5 text-center">
                    <form action="" class="w-75 mx-auto">
                        ...
                        <div class="form-group">
                            <input type="text" name="email" id="email" class="form-control form-control-lg rounded-pill bg-dark text-light text-center" placeholder="Email">
                        </div>
                        <button class="mt-4 btn btn-warning rounded-pill text-dark btn-block submit p-3" type="submit">Submit</button>
                    </form>
                </div>
            </div>
        </div>
