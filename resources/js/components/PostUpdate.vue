              ...
              <div class="media-object">
                    ...
                    <p >{{post.created_at | formatDate}}</p>
                                ...
                                <v-list v-if="postUser[post.id] == user.username">
                                    <v-list-item
                                    >
                                    <v-list-item-title class="pointer" @click.stop="openDialogDelete(post.id)">Hapus postinagan ini </v-list-item-title>
                                    </v-list-item>
                                </v-list>
                                </v-menu>
...
<!--           
  ...
  <!-- <v-btn color="yellow" class="mb-2" dark block @click="morePost()"> Lihat Selanjutnya</v-btn> -->
  </div>
</template>
